        ...
        <div class="row ">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <nav class="navbar navbar-expand-md  navbar-dark fixed-top" id="nv">
                    ...
                    <div id="guiado">
                        <div class="btn-group">
                            <a class="btn btn-outline-info dropdown-toggle dropdown-right" data-toggle="dropdown"><img id="admin"src="/RapidFast/admin/image/admin.png"></a>
                    ...
                    <tbody>
                        <%  
                            ...
                            <tr>
                                ...
                                <td><a href="/RapidFast/admin/mispedidos.jsp?id_venta=<%=vlista.get(i).getId_venta()%>">Mas Detalles</a></td>
                            </tr> 
                         <%}}%>
                    </tbody>
                </table>
