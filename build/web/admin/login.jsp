...
<html>
    <head>
        ...
        <script type="text/javascript" src="/RapidFast/admin/js/validar_login.js"></script>
    </head>
    <body>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="text-center">
                                <br>
                                <img src="/RapidFast/admin/img/iniciar_sesion.png" >
                            </div> 
                            <form action="/RapidFast/AutorizarUsuario" id="login1" name="login2" role="form" method="post">
                                <div class="card-body">
