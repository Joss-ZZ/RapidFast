    ...
    <body>
        <script>
            function suma(){
                ...
                var tot=document.getElementById('valor_max').value; // CANTIDAD DE STOCK - VALOR MAXIMO
                var precio=document.getElementById('valor_precio').value; // PRECIO PRODUCTO
                if(tot<num) // TOT >num
                {
                    num++;
            ...
            function login()
            {
                ...
                $("#contenidologin").load("/RapidFast/admin/login.jsp");
            }
            function registrar()
            {
                document.getElementById("contenidoregistro").innerHTML="";
                $('#newregistroo').modal('show');
                $("#contenidoregistro").load("/RapidFast/admin/Iniciar_sesion.jsp");
            }
            function recuperarcuenta()
            {
                document.getElementById("contenidorecuperarcuenta").innerHTML="";
                $('#newrecuperarcuentaa').modal('show');
                $("#contenidorecuperarcuenta").load("/RapidFast/admin/Recuperar_cuenta.jsp");
            }
            function comentarios(idpro)
            {
                document.getElementById("contenidocomentario").innerHTML="";
                $('#newcomentario').modal('show');
                $("#contenidocomentario").load("/RapidFast/admin/comentarios.jsp?id_pro="+idpro+"");
            }
            function califica(valor,id_pro,id_venta){
                alert(valor+" - "+id_pro+" - "+id_venta);
                window.open("/RapidFast/mante_califi?val="+valor+"&id_pro="+id_pro+"&id_venta="+id_venta+"","_self");
            }
            function pagina(id_user,id_ven){
            window.open("/RapidFast/admin/boucher.jsp?id_us="+id_user+"&id_ve="+id_ven+"");
            }
            function verproducto(idpro)
            {
                window.open("/RapidFast/admin/Modal_pro.jsp?id_pro="+idpro+"","_self");
            }
            function vista(cat){
              var testvalue = cat;
        ...
        <div class="row ">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <nav class="navbar navbar-expand-md  navbar-dark fixed-top" id="nv">
                    ...
                    <div class="collapse navbar-collapse" id="collap">
                        <ul class="navbar-nav">
                            <li class="nav-item active" >
                                <a class="nav-link" href="http://localhost:8080/index.jsp">Productos</a>
                            </li>
                        </ul>
                    </div>
                    <!-- alertaa****************************** -->
                    ...
                    <div id="guiado">
                         <!--ACA IBA UN CODIGO NO IMPORTANTE Y LO SAQUE-->
                    </div>
                       ...
                       <button  style=" border:none"class="btn btn-outline-light dropdown-toggle dropdown-right" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right  text-center">
                             <a class="dropdown-item" href="#">
                                 <img src="/RapidFast/admin/image/user.png" alt="60" width="60">
                             </a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <a href="/RapidFast/admin/mispedidos.jsp" class="nav-link " >Mis pedidos</a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div id="stilo" class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                            ...
                                            <div  class="row" >
                                                <div id="modal_basura" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                    <div>
                                                        <a type="button" class="close" href="/RapidFast/mante_carrito?car=<%=carlista.get(p).getId_venta()%>&pro=<%=carlista.get(p).getId_product() %>"><img id="bt_basura" src="/admin/image/basura.png"></a>        
                                                    </div>
                                                </div>    
                                            </div>    
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <%if(user!=null){%>
                                    <a href="/RapidFast/mante_venta?id_user=<%=newid_usuario %>&id_ven=<%=newid_venta %>" type="button" class="btn btn-success" onclick="pagina(<%=newid_usuario %>,<%=newid_venta %>)">Comprar</a>
                                    <%}%>
